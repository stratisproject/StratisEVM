...
2. Extract into a location on your host, for example `C:\execution` or `~/execution`
3. Navigate to your `execution` directory and execute the following command:
...
-----------------------------------------------------------------
Download - ideally on a new machine that has never been connected to the internet - the latest stable version of the deposit CLI from the [Staking Deposit CLI Releases page](https://github.com/stratisproject/staking-deposit-cli).
...
Go to the Stratis Staking Launchpad site and continue through the prompts upload your `deposit_data-*.json` file. You’ll be prompted to connect your wallet. 
